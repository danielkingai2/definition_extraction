...
from definition_extraction.utils import constant, helper, vocab
...
class DataLoaderDictInput(object):
    """
    Load data from json files, preprocess and prepare batches.
    """

    def __init__(self, input_dicts, batch_size, opt, vocab, evaluation=False):
        self.batch_size = batch_size
        self.opt = opt
        self.vocab = vocab
        self.eval = evaluation
        ...
        self.raw_data = input_dicts
        data = self.preprocess(self.raw_data, vocab, opt)
